...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server" >
    ...
    <form id="form1" runat="server" class="flex flex-col items-center h-screen p-6 bg-white shadow-lg rounded-lg">
...
">
        ...
        <div class="flex-col items-center justify-center">
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="User Full Name" DataValueField="ID">
            </asp:DropDownList>
        </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select id, first_name || ' ' || last_name &quot;User Full Name&quot; from users"></asp:SqlDataSource>
    </form>
</asp:Content>
